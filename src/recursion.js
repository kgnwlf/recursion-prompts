...
var exponent = function(base, exp) {
  ...
  if (exp < 0) {
    var negativeExp = 1 / base;
    return negativeExp *= exponent(base, (exp + 1));
  }
};
...
var reverse = function(string) {
  ...
  var oneLessLetter = string.slice(0, -1);
  return lastLetter + reverse(oneLessLetter);
};
...
var palindrome = function(string) {
  ...
  var firstLetter = newString.slice(0, 1);
  var lastLetter = newString.slice(newString.length - 1);
  var newWord = newString.slice(1, -1);
